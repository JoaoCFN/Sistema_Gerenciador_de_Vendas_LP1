...
void alterar_dados_unidade(int posicao){
  ...
  RESPECTIVA PARA A MUDANÇA. APÓS ISSO, O NOVO VALOR É LIDO E É ARMAZENADO NA POSIÇÃO */
  printf(" \n------------------------------------------------ \n");
...
void mostrar_tabela_vendas(){
    ...
    // LOOP QUE PRINTA A MATRIZ DE QUANTIDADE DO TXT
    for (i = 0; i < 10; i++){
...
void mostrar_tabela_preco(){
    ...
    // PRINTA O VETOR DE PREÇO DO TXT
    for (i = 0;  i < 10; i++){
...
void exiba_quantidade_dia(){
  // O USUÁRIO ESCOLHE UM DIA ESPECÍFICO (LINHA) E O FOR PERCORRE AS COLUNAS
  printf(" \n------------------------------------------------ \n");
  printf("ESCOLHA O DIA: \n0 - DOMINGO \n1 - SEGUNDA \n2 - TERCA \n3 - QUARTA \n4 - QUINTA \n5 - SEXTA \n6 - SABADO\n");
  scanf("%d", &dia);
  if (dia >= 0 && dia < 7){
...
void exiba_quantidade_semana(){
  // O USUÁRIO ESCOLHE UM PRODUTO ESPECÍFICO (POSIÇÃO) E O FOR PERCORRE O VETOR
  printf(" \n------------------------------------------------ \n");
...
void gerar_relatorio (relatorio){
    ...
    // PRINTA A MATRIZ DE QUANTIDADE DO TXT
    for (i = 0; i < 10; i++){
    ...
    fprintf(relatorio, "\n");
    for (i = 0; i < 7; i++){
    	// QUANTIDADE TOTAL DE VENDAS REAIS
...
int main(){
    ...
    while (continuar != 0){
        ...
        switch(opcao){
          case 1:
          	  // OPÇÃO PARA VER TABELA DE PRODUTOS
              mostrar_tabela_vendas();
            
          break;

          case 2:
              // OPÇÃO PARA VER PREÇO DOS PRODUTOS
              mostrar_tabela_preco();

          break;

          case 3:
              // OPÇÃO PARA ALTERAR DADOS INFORMADOS
              printf(" \n------------------------------------------------ \n");
              printf("ESCOLHA O PRODUTO: \n0 - FARINHA \n1 - ARROZ \n2 - FEIJAO \n3 - FRANGO \n4 - CARNE \n5 - SABONETE \n6 - ESCOVA \n7 - PASTA \n8 - SHAMPOO \n9 - CONDICIONADOR \n");
              scanf("%d", &posicao);
              printf(" \n------------------------------------------------ \n");
          ...
          case 4:
          	// VER A QUANTIDADE DE PRODUTOS VENDIDOS A PARTIR DE UM DIA DA SEMANA (EM UNIDADE E EM REAIS)
          ...
          case 5:
          	// VER A QUANTIDADE DO MESMO PRODUTO VENDIDO NA SEMANA (EM UNIDADE E EM REAIS)
